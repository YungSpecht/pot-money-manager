...
A simple, mobile-first PWA that lets you virtually split a single reserve bank account into named "pots" (e.g., Car,
Travel, Insurance). All data is stored locally on your device using localStorage.
