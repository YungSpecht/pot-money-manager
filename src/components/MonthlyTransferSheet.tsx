...
export function MonthlyTransferSheet({open, onClose, data, setMonthlyTransfer, processMonthlyTransfer, setLastTransferDate}: Props) {
    ...
    const updateSplit = (potId: string, field: keyof SplitRule, value: string | number) => {
        setSplits(s => s.map(r => r.potId === potId ? {
            ...r,
            ...
            <SheetContent side="bottom" className="rounded-t-2xl max-h-[85vh] overflow-y-auto">
                ...
                <div className="space-y-4 mt-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-xs text-muted-foreground">Allocated: €{splitSum.toFixed(2)} /
                        ...
                        {data.pots.map(pot => {
                            ...
                            return (
                                <div key={pot.id} className="flex items-center gap-2">
                                    ...
                                    <Select value={rule?.type ?? 'fixed'}
                                            onValueChange={v => updateSplit(pot.id, 'type', v)}>
